...
const PerfilRepartidor = () => {
  return (
    <View className="w-full bg-verde h-full flex flex-col items-center">
        ...
        <View className="w-72 h-10 flex flex-row rounded-xl items-center justify-around mt-6 bg-amarilloVerdoso">
        ...
        <View className="w-72 h-12 flex justify-center rounded-xl mt-4 bg-amarilloVerdoso">
            <View className="w-72 h-12 flex flex-row rounded-t-xl items-center justify-between">
                <View>
                    <Text className="text-sm ml-5 h-3 font-bold text-texto">REPARTOS PENDIENTES</Text>
                    <Text className="text-sm ml-5 h-3 mb-2 font-medium text-texto">sin repartos</Text>
                </View>
        ...
        <View className="w-72 h-64 flex rounded-t-xl mt-4 bg-white">
            <View className="w-72 h-10 flex flex-row rounded-xl items-center justify-between bg-amarilloVerdoso">
                <Text className="text-sm ml-5 font-bold text-texto">HISTORIAL DE REPARTOS</Text>
                <Pressable className="mr-5">
            ...
            <View className="flex flex-col h-48 justify-evenly items-center">
                <View className="flex flex-row justify-evenly items-center w-full">
                    ...
                    <View className="flex flex-col items-end justify-center gap-1">
                        <View className="w-[88] h-[15] flex flex-row justify-evenly items-center rounded-md bg-gray-300">
