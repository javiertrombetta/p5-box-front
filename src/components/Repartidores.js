...
const Repartidores = () => {
  return (
    <View className="bg-verde w-full h-full flex-col flex py-2 px-4">
      <View className="flex-row justify-items-start flex justify-between py-2 px-4">
        <Svg
      ...
      <View className="bg-amarilloVerdoso flex-row flex justify-between py-2 mt-3 mx-2 rounded-xl">
