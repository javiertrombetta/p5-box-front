    ...
    <View className="bg-verde w-full h-full items-center flex-col flex py-2 px-4">
      <View className="flex-row w-[300] mt-[12] justify-items-start flex justify-between">
        ...
        <Pressable className="w-28 h-7 flex justify-center items-center align-middle border rounded-xl border-black text-black mt-1">
          <Text className="text-center text-texto text-xs font-roboto">CERRAR SESIÓN</Text>
        </Pressable>
      </View>
      <View className="bg-amarilloVerdoso flex-row flex justify-between px-4 mt-5 rounded-xl w-[300] h-[40]">
        <Text className="text-lg py-1 text-texto font-sairaBold">PAQUETES</Text>
            ...
            <View className="flex flex-col h-[310] px-4 items-center justify-between">
                ...
                <View className="flex flex-row justify-between items-center w-full">
                    <View className="flex flex-row justify-start items-center gap-5 h-[75] w-[150]">
                        ...
                        <View className="flex justify-center w-full">
                            <Text className="font-robotoMedium text-texto text-xs">#0H167</Text>
                            <Text className="text-texto text-xs font-roboto">Av. Carabobo y Rivadavia,</Text>
                            <Text className="text-texto text-x font-roboto">CABA</Text>
                        </View>
                    </View>
                    <View className="flex flex-col items-end justify-center gap-1">
                        <Pressable className="flex flex-row h-6 w-14 justify-end items-center">
                ...
                <View className="flex flex-row justify-between items-center w-full">
                    <View className="flex flex-row justify-start items-center gap-5 h-[75] w-[150]">
                        ...
                        <View className="flex justify-center w-full">
                            <Text className="font-robotoMedium text-texto text-xs">#0A903</Text>
                            <Text className="text-texto text-xs font-roboto">Av. Las Heras 5678,</Text>
                            <Text className="text-texto text-xs font-roboto">CABA</Text>
                        </View>
                    </View>
                    <View className="flex flex-col items-end justify-center gap-1">
                ...
                <View className="flex flex-row justify-between items-center w-full">
                    <View className="flex flex-row justify-start items-center gap-5 h-[75] w-[150]">
                        ...
                        <View className="flex justify-center w-full">
                            <Text className="font-robotoMedium text-texto text-xs">#0A235</Text>
                            <Text className="text-texto text-xs font-roboto">Av. Amenabar 2356,</Text>
                            <Text className="text-texto text-xs font-roboto">CABA</Text>
                        </View>
                    </View>
                    <View className="flex flex-col items-end justify-center gap-1">
                ...
                <View className="flex flex-row justify-between items-center w-full">
                    <View className="flex flex-row justify-start items-center gap-5 h-[75] w-[150]">
                        ...
                        <View className="flex justify-center w-full">
                            <Text className="font-robotoMedium text-texto text-xs">#0G370</Text>
                            <Text className="text-texto text-xs font-roboto">Av. Heredia 785,</Text>
                            <Text className="text-texto text-xs font-roboto">CABA</Text>
                        </View>
                    </View>
                    <View className="flex flex-col items-end justify-center gap-1">
